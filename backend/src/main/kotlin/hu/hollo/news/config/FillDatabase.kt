...
class FillDatabase(passwordEncoder: PasswordEncoder) {
    ...
    private val events = listOf(
        Event(
            ...
            hasPoints = false,
            startDate = LocalDateTime.parse("2023-03-06T12:00:00.00"), //"2018-12-30T19:34:50.63"
            endDate = LocalDateTime.parse("2023-03-06T15:00:00.00"),
        ),
        Event(
            ...
            hasPoints = true,
            startDate = LocalDateTime.parse("2023-03-06T17:00:00.00"),
            endDate = LocalDateTime.parse("2023-03-06T20:00:00.00"),
        ),
        Event(
            ...
            organizer = "Lunch Talks",
            hasPoints = true,
            startDate = LocalDateTime.parse("2023-03-07T09:00:00.00"),
            endDate = LocalDateTime.parse("2023-03-07T11:00:00.00"),
        ),
        Event(
            ...
            hasPoints = false,
            startDate = LocalDateTime.parse("2023-03-08T16:00:00.00"),
            endDate = LocalDateTime.parse("2023-03-08T19:00:00.00"),
        ),
    );
